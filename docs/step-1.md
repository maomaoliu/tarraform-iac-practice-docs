...
- 如果使用的电脑是 Mac M1 系列，需要修改 DockerFile 使用的 base image 为 `arm64v8/amazoncorretto:17`
  - [DockerFile in book-service](../apps/book-service/Dockerfile)
  - [DockerFile in order-service](../apps/order-service/Dockerfile)
  - [DockerFile in web-app](../apps/web-app/Dockerfile)
